const_value = 1
	...
	const SLASH        ; a3
	const SUBSTITUTE   ; a4
	const STRUGGLE     ; a5 ; Original Moveset Ends
	const ZOUND        ; a6
	const ZARATE_CHOP  ; a7
	const ZOUBLESLAP   ; a8
	const ZOMET_PUNCH  ; a9
	const ZEGA_PUNCH   ; aa
	const ZAY_DAY      ; ab
	const ZIRE_PUNCH   ; ac
	const ZCE_PUNCH    ; ad
	const ZHUNDERPUNCH ; ae
	const ZCRATCH      ; af
	const ZICEGRIP     ; b0
	const ZUILLOTINE   ; b1
	const ZAZOR_WIND   ; b2
	const ZWORDS_DANCE ; b3
	const ZUT          ; b4
	const ZUST         ; b5
	const ZING_ATTACK  ; b6
	const ZHIRLWIND    ; b7
	const ZLY          ; b8
	const ZIND         ; b9
	const ZLAM         ; ba
	const ZINE_WHIP    ; bb
	const ZTOMP        ; bc
	const ZOUBLE_KICK  ; bd
	const ZEGA_KICK    ; be
	const ZUMP_KICK    ; bf
	const ZOLLING_KICK ; c0
	const ZAND_ATTACK  ; c1
	const ZEADBUTT     ; c2
	const ZORN_ATTACK  ; c3
	const ZURY_ATTACK  ; c4
	const ZORN_DRILL   ; c5
	const ZACKLE       ; c6
	const ZODY_SLAM    ; c7
	const ZRAP         ; c8
	const ZAKE_DOWN    ; c9
	const ZHRASH       ; ca
	const ZOUBLE_EDGE  ; cb
	const ZAIL_WHIP    ; cc
	const ZOISON_STING ; cd
	const ZWINEEDLE    ; ce
	const ZIN_MISSILE  ; cf
	const ZEER         ; d0
	const ZITE         ; d1
	const ZROWL        ; d2
	const ZOAR         ; d3
	...
	const ZAZOR_LEAF   ; f0
	const ZOLARBEAM    ; f1
	const ZOISONPOWDER ; f2
	const ZTUN_SPORE   ; f3
	const ZLEEP_POWDER ; f4
	const ZETAL_DANCE  ; f5
	const ZTRING_SHOT  ; f6
	const ZRAGON_RAGE  ; f7
	const ZIRE_SPIN    ; f8
	const ZHUNDERSHOCK ; f9
	const ZHUNDERBOLT  ; fa
