CeruleanCave1F_Object:
	...
	warp 24, 17, 6, -1
	warp 25, 17, 6, -1
	warp  3, 11, 0, CERULEAN_CAVE_2F
	warp 27,  1, 1, CERULEAN_CAVE_2F
	warp 23,  7, 2, CERULEAN_CAVE_2F
	warp  7,  1, 3, CERULEAN_CAVE_2F
	warp  0,  6, 4, CERULEAN_CAVE_2F
	warp 18,  9, 5, CERULEAN_CAVE_2F
	warp  1,  3, 0, CERULEAN_CAVE_B1F
	...
	warp_to  0,  6, CERULEAN_CAVE_1F_WIDTH ; CERULEAN_CAVE_2F
	warp_to 18,  9, CERULEAN_CAVE_1F_WIDTH ; CERULEAN_CAVE_2F
	warp_to  1,  3, CERULEAN_CAVE_1F_WIDTH ; CERULEAN_CAVE_B1F
