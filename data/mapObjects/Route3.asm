Route3_Object:
	...
	object SPRITE_LASS, 22,  4, STAY, LEFT, 6, OPP_LASS, 2
	object SPRITE_BUG_CATCHER, 22, 9, STAY, LEFT, 7, OPP_YOUNGSTER, 2
	object SPRITE_BUG_CATCHER, 24,  4, STAY, RIGHT, 8, OPP_BUG_CATCHER, 6
	object SPRITE_LASS, 31,  8, STAY, UP, 9, OPP_LASS, 3
