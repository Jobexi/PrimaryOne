Route19_Object:
	...
	object SPRITE_SWIMMER,  7, 46, STAY, LEFT, 7, OPP_BEAUTY, 12
	object SPRITE_SWIMMER,  8, 45, STAY, RIGHT, 8, OPP_BEAUTY, 13
	object SPRITE_SWIMMER,  7, 45, STAY, UP, 9, OPP_SWIMMER, 8
