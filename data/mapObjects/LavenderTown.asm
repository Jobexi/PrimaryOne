LavenderTown_Object:
	...
	warp_to  3, 13, LAVENDER_TOWN_WIDTH ; MR_FUJIS_HOUSE
	warp_to 15, 13, LAVENDER_TOWN_WIDTH ; LAVENDER_MART
	warp_to 11, 13, LAVENDER_TOWN_WIDTH ; LAVENDER_CUBONE_HOUSE
