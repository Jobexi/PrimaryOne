SSAnne1F_Object:
	...
	warp 23,  8, 0, SS_ANNE_1F_ROOMS
	warp 19,  8, 1, SS_ANNE_1F_ROOMS
	warp 15,  8, 2, SS_ANNE_1F_ROOMS
	warp 11,  8, 3, SS_ANNE_1F_ROOMS
	warp  7,  8, 4, SS_ANNE_1F_ROOMS
	warp 31,  8, 5, SS_ANNE_1F_ROOMS
