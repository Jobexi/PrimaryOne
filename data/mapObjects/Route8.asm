Route8_Object:
	...
	object SPRITE_LASS, 25,  9, STAY, LEFT, 4, OPP_LASS, 13
	object SPRITE_BLACK_HAIR_BOY_2, 25,  8, STAY, RIGHT, 5, OPP_SUPER_NERD, 5
	object SPRITE_LASS, 25,  7, STAY, LEFT, 6, OPP_LASS, 14
	object SPRITE_LASS, 25,  6, STAY, RIGHT, 7, OPP_LASS, 15
