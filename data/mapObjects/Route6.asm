Route6_Object:
	...
	warp 15, 13, 0, UNDERGROUND_PATH_ROUTE_6

	db 1 ; signs
	sign 15, 15, 7 ; Route6Text7
	...
	object SPRITE_BUG_CATCHER, 20, 26, STAY, LEFT, 6, OPP_BUG_CATCHER, 11

	; warp-to
	warp_to 10,  1, ROUTE_6_WIDTH ; ROUTE_6_GATE
	warp_to 10,  1, ROUTE_6_WIDTH ; ROUTE_6_GATE ; KEEP THIS DUPLICATE
	warp_to 10, 7, ROUTE_6_WIDTH ; ROUTE_6_GATE
	warp_to 15, 13, ROUTE_6_WIDTH ; UNDERGROUND_PATH_ROUTE_6
