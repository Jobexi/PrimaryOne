MtMoonB2F_Object:
	...
	db 4 ; warps
	warp 21, 17, 1, MT_MOON_B1F
	warp 25,  9, 4, MT_MOON_B1F
	warp  7, 27, 5, MT_MOON_B1F
	...
	object SPRITE_ROCKET, 27, 23, STAY, DOWN, 3, OPP_ROCKET, 2
	object SPRITE_ROCKET, 26, 11, STAY, UP, 4, OPP_ROCKET, 3
	object SPRITE_ROCKET, 34, 16, STAY, LEFT, 5, OPP_ROCKET, 4
	object SPRITE_OMANYTE, 12, 6, STAY, NONE, 6 ; person
	object SPRITE_OMANYTE, 13, 6, STAY, NONE, 7 ; person
	object SPRITE_BALL, 31, 21, STAY, NONE, 8, HP_UP
	object SPRITE_BALL, 33,  5, STAY, NONE, 9, TM_01

	; warp-to
	warp_to 21, 17, MT_MOON_B2F_WIDTH ; MT_MOON_B1F
	warp_to 25,  9, MT_MOON_B2F_WIDTH ; MT_MOON_B1F
	warp_to  7, 27, MT_MOON_B2F_WIDTH ; MT_MOON_B1F
