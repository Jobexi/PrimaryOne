VermilionCity_Object:
	...
	sign 33, 13, 8 ; VermilionCityText8
	sign 22, 13, 9 ; MartSignText
	...
	object SPRITE_GAMBLER, 28,  7, STAY, NONE, 4 ; person
	object SPRITE_SLOWBRO, 27,  9, WALK, 1, 5 ; person
	...
	warp_to 21, 13, VERMILION_CITY_WIDTH ; VERMILION_MART
