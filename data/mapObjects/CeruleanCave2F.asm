CeruleanCave2F_Object:
	...
	db 6 ; warps
	warp 22,  6, 2, CERULEAN_CAVE_1F
	warp 29,  1, 3, CERULEAN_CAVE_1F
	warp  9,  1, 4, CERULEAN_CAVE_1F
	warp 19,  7, 5, CERULEAN_CAVE_1F
	warp  3, 11, 6, CERULEAN_CAVE_1F
	warp  1,  3, 7, CERULEAN_CAVE_1F
