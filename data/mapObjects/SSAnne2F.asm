SSAnne2F_Object:
	...
	db 9 ; warps
	warp 29, 11, 0, SS_ANNE_2F_ROOMS
	warp  9, 11, 2, SS_ANNE_2F_ROOMS
	warp 13, 11, 4, SS_ANNE_2F_ROOMS
	warp 17, 11, 6, SS_ANNE_2F_ROOMS
	warp 21, 11, 8, SS_ANNE_2F_ROOMS
	warp 25, 11, 10, SS_ANNE_2F_ROOMS
