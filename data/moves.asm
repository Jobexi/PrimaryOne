...
MoveEnd:
	...
	move ZARATE_CHOP,  NO_ADDITIONAL_EFFECT,        50, NORMAL,   100, 25
	move ZOUBLESLAP,   TWO_TO_FIVE_ATTACKS_EFFECT,  15, NORMAL,    85, 10
	move ZOMET_PUNCH,  TWO_TO_FIVE_ATTACKS_EFFECT,  18, NORMAL,    85, 15
	move ZEGA_PUNCH,   NO_ADDITIONAL_EFFECT,        80, NORMAL,    85, 20
	move ZAY_DAY,      PAY_DAY_EFFECT,              40, NORMAL,   100, 20
	move ZIRE_PUNCH,   BURN_SIDE_EFFECT1,           75, FIRE,     100, 15
	move ZCE_PUNCH,    FREEZE_SIDE_EFFECT,          75, ICE,      100, 15
	move ZHUNDERPUNCH, PARALYZE_SIDE_EFFECT1,       75, ELECTRIC, 100, 15
	move ZCRATCH,      NO_ADDITIONAL_EFFECT,        40, NORMAL,   100, 35
	move ZICEGRIP,     NO_ADDITIONAL_EFFECT,        55, NORMAL,   100, 30
	move ZUILLOTINE,   OHKO_EFFECT,                  1, NORMAL,    30,  5
	move ZAZOR_WIND,   CHARGE_EFFECT,               80, NORMAL,    75, 10
	move ZWORDS_DANCE, ATTACK_UP2_EFFECT,            0, NORMAL,   100, 30
	move ZUT,          NO_ADDITIONAL_EFFECT,        50, NORMAL,    95, 30
	move ZUST,         NO_ADDITIONAL_EFFECT,        40, NORMAL,   100, 35
	move ZING_ATTACK,  NO_ADDITIONAL_EFFECT,        35, FLYING,   100, 35
	move ZHIRLWIND,    SWITCH_AND_TELEPORT_EFFECT,   0, NORMAL,    85, 20
	move ZLY,          FLY_EFFECT,                  70, FLYING,    95, 15
	move ZIND,         TRAPPING_EFFECT,             15, NORMAL,    75, 20
	move ZLAM,         NO_ADDITIONAL_EFFECT,        80, NORMAL,    75, 20
	move ZINE_WHIP,    NO_ADDITIONAL_EFFECT,        35, GRASS,    100, 10
	move ZTOMP,        FLINCH_SIDE_EFFECT2,         65, NORMAL,   100, 20
	move ZOUBLE_KICK,  ATTACK_TWICE_EFFECT,         30, FIGHTING, 100, 30
	move ZEGA_KICK,    NO_ADDITIONAL_EFFECT,       120, NORMAL,    75,  5
	move ZUMP_KICK,    JUMP_KICK_EFFECT,            70, FIGHTING,  95, 25
	move ZOLLING_KICK, FLINCH_SIDE_EFFECT2,         60, FIGHTING,  85, 15
	move ZAND_ATTACK,  ACCURACY_DOWN1_EFFECT,        0, NORMAL,   100, 15
	move ZEADBUTT,     FLINCH_SIDE_EFFECT2,         70, NORMAL,   100, 15
	move ZORN_ATTACK,  NO_ADDITIONAL_EFFECT,        65, NORMAL,   100, 25
	move ZURY_ATTACK,  TWO_TO_FIVE_ATTACKS_EFFECT,  15, NORMAL,    85, 20
	move ZORN_DRILL,   OHKO_EFFECT,                  1, NORMAL,    30,  5
	move ZACKLE,       NO_ADDITIONAL_EFFECT,        35, NORMAL,    95, 35
	move ZODY_SLAM,    PARALYZE_SIDE_EFFECT2,       85, NORMAL,   100, 15
	move ZRAP,         TRAPPING_EFFECT,             15, NORMAL,    85, 20
	move ZAKE_DOWN,    RECOIL_EFFECT,               90, NORMAL,    85, 20
	move ZHRASH,       THRASH_PETAL_DANCE_EFFECT,   90, NORMAL,   100, 20
	move ZOUBLE_EDGE,  RECOIL_EFFECT,              100, NORMAL,   100, 15
	move ZAIL_WHIP,    DEFENSE_DOWN1_EFFECT,         0, NORMAL,   100, 30
	move ZOISON_STING, POISON_SIDE_EFFECT1,         15, POISON,   100, 35
	move ZWINEEDLE,    TWINEEDLE_EFFECT,            25, BUG,      100, 20
	move ZIN_MISSILE,  TWO_TO_FIVE_ATTACKS_EFFECT,  14, BUG,       85, 20
	move ZEER,         DEFENSE_DOWN1_EFFECT,         0, NORMAL,   100, 30
	move ZITE,         FLINCH_SIDE_EFFECT1,         60, NORMAL,   100, 25
	move ZROWL,        ATTACK_DOWN1_EFFECT,          0, NORMAL,   100, 40
	move ZOAR,         SWITCH_AND_TELEPORT_EFFECT,   0, NORMAL,   100, 20
	move ZING,         SLEEP_EFFECT,                 0, NORMAL,    55, 15
	move ZUPERSONIC,   CONFUSION_EFFECT,             0, NORMAL,    55, 20
	move ZONICBOOM,    SPECIAL_DAMAGE_EFFECT,        1, NORMAL,    90, 20
	move ZISABLE,      DISABLE_EFFECT,               0, NORMAL,    55, 20
	move ZCID,         DEFENSE_DOWN_SIDE_EFFECT,    40, POISON,   100, 30
	move ZMBER,        BURN_SIDE_EFFECT1,           40, FIRE,     100, 25
	move ZLAMETHROWER, BURN_SIDE_EFFECT1,           95, FIRE,     100, 15
	move ZIST,         MIST_EFFECT,                  0, ICE,      100, 30
	move ZATER_GUN,    NO_ADDITIONAL_EFFECT,        40, WATER,    100, 25
	move ZYDRO_PUMP,   NO_ADDITIONAL_EFFECT,       120, WATER,     80,  5
	move ZURF,         NO_ADDITIONAL_EFFECT,        95, WATER,    100, 15
	move ZCE_BEAM,     FREEZE_SIDE_EFFECT,          95, ICE,      100, 10
	move ZLIZZARD,     FREEZE_SIDE_EFFECT,         120, ICE,       90,  5
	move ZSYBEAM,      CONFUSION_SIDE_EFFECT,       65, PSYCHIC,  100, 20
	move ZUBBLEBEAM,   SPEED_DOWN_SIDE_EFFECT,      65, WATER,    100, 20
	move ZURORA_BEAM,  ATTACK_DOWN_SIDE_EFFECT,     65, ICE,      100, 20
	move ZYPER_BEAM,   HYPER_BEAM_EFFECT,          150, NORMAL,    90,  5
	move ZECK,         NO_ADDITIONAL_EFFECT,        35, FLYING,   100, 35
	move ZRILL_PECK,   NO_ADDITIONAL_EFFECT,        80, FLYING,   100, 20
	move ZUBMISSION,   RECOIL_EFFECT,               80, FIGHTING,  80, 25
	move ZOW_KICK,     FLINCH_SIDE_EFFECT2,         50, FIGHTING,  90, 20
	move ZOUNTER,      NO_ADDITIONAL_EFFECT,         1, FIGHTING, 100, 20
	move ZEISMIC_TOSS, SPECIAL_DAMAGE_EFFECT,        1, FIGHTING, 100, 20
	move ZTRENGTH,     NO_ADDITIONAL_EFFECT,        80, NORMAL,   100, 15
	move ZBSORB,       DRAIN_HP_EFFECT,             20, GRASS,    100, 20
	move ZEGA_DRAIN,   DRAIN_HP_EFFECT,             40, GRASS,    100, 10
	move ZEECH_SEED,   LEECH_SEED_EFFECT,            0, GRASS,     90, 10
	move ZROWTH,       SPECIAL_UP1_EFFECT,           0, NORMAL,   100, 40
	move ZAZOR_LEAF,   NO_ADDITIONAL_EFFECT,        55, GRASS,     95, 25
	move ZOLARBEAM,    CHARGE_EFFECT,              120, GRASS,    100, 10
	move ZOISONPOWDER, POISON_EFFECT,                0, POISON,    75, 35
	move ZTUN_SPORE,   PARALYZE_EFFECT,              0, GRASS,     75, 30
	move ZLEEP_POWDER, SLEEP_EFFECT,                 0, GRASS,     75, 15
	move ZETAL_DANCE,  THRASH_PETAL_DANCE_EFFECT,   70, GRASS,    100, 20
	move ZTRING_SHOT,  SPEED_DOWN1_EFFECT,           0, BUG,       95, 40
	move ZRAGON_RAGE,  SPECIAL_DAMAGE_EFFECT,        1, DRAGON,   100, 10
	move ZIRE_SPIN,    TRAPPING_EFFECT,             15, FIRE,      70, 15
	move ZHUNDERSHOCK, PARALYZE_SIDE_EFFECT1,       40, ELECTRIC, 100, 30
	move ZHUNDERBOLT,  PARALYZE_SIDE_EFFECT1,       95, ELECTRIC, 100, 15